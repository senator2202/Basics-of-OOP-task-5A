...
import FlowerCompositionPackage.FlowersPackage.Tulip;
import FlowerCompositionPackage.Package;

import java.util.Random;

/**
 * Класс для создания композиции из тюльпанов, который переопределяет метод суперкласса
 * makeFlowerComposition(), который инициализирует и возвращает
 * объект - цветочную композцию из тюльпанов
 */
public class TulipCompositionMaker extends CompositionMaker {
    @Override
    public FlowerComposition makeFlowerComposition() {
        ...
        Flower flower = new Tulip(color, r.nextInt(30) + 30);
